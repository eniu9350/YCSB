...
public class RedisMongodbRawClient extends DB {
	...
	public int read(String table, String key, Set<String> fields,
		...
		if (fields == null) {
			StringByteIterator
					.putAllAsByteIterators(result, jedis.hgetAll(key));
		} else {
			String[] fieldArray = (String[]) fields.toArray(new String[fields
					.size()]);
			...
			while (fieldIterator.hasNext() && valueIterator.hasNext()) {
				result.put(fieldIterator.next(), new StringByteIterator(
						valueIterator.next()));
			}
	...
	public int insert(String table, String key,
		...
		if (jedis.hmset(key, StringByteIterator.getStringMap(values)).equals(
				"OK")) {
